    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(pre3, file, 205, 4, 7463);
    			add_location(p13, file, 209, 4, 8191);
    			attr_dev(span29, "class", "code svelte-1u11mpd");
    			add_location(span29, file, 210, 55, 8331);
    			attr_dev(span30, "class", "code svelte-1u11mpd");
    			add_location(span30, file, 210, 88, 8364);
    			add_location(p14, file, 210, 4, 8280);
    			attr_dev(h23, "class", "svelte-1u11mpd");
    			add_location(h23, file, 211, 4, 8412);
    			add_location(p15, file, 212, 4, 8436);
    			attr_dev(div20, "class", "wrapper");
    			add_location(div20, file, 171, 2, 3953);
    			attr_dev(div21, "class", div21_class_value = "" + (null_to_empty(/*state*/ ctx[1]) + " svelte-1u11mpd"));
    			add_location(div21, file, 144, 0, 3119);
    			add_location(main, file, 143, 0, 3112);
    		},
